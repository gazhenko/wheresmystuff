...
public class AdminEditActivity extends Activity {
        ...
        String tempName, tempPass, tempPhon,rbLock,rbAdmin;
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                String name = Login.users.get(AdminActivity.clickTask).getPhoneNumber();
...
//              String name = Login.users.get(AdminActivity.clickTask).getUserName();
//              System.out.println(name);
//          info.open();
//              info.updataUserEntry(rowid, tempName, tempPass, tempPhon, rbAdmin, rbLock);
//              info.close();
                ...
                bSub.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                ...
                                // if admin user is selected to be non - admin
